  ...
  "definitions": {
    "TestCase": {
      ...
      "properties": {
        ...
        "number":      { "type": "string", "pattern": "^[A-Z]{2,4}-[A-Z]{2,4}-\\d{8}-\\d{3}$" },
        "title":       { "type": "string" },
    ...
    "CaseType":   { "type": "string", "enum": ["functionality", "performance", "api", "ui", "security"] },
    "Priority":   { "type": "string", "enum": ["P0", "P1", "P2", "P3"] },
    "CaseStatus": { "type": "string", "enum": ["unexecuted", "pass", "block", "fail"] }
  }
}
```
